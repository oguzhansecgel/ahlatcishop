...
namespace Ahlatci.Shop.Persistence.Migrations
{
    ...
    [Migration("20230805110852_customerAccountIdColumDeleted")]
    partial class customerAccountIdColumDeleted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ahlatci.Shop.Domain.Entites.Account", b =>
                {
                    b.HasOne("Ahlatci.Shop.Domain.Entites.Customer", "Customer")
                        .WithOne("Account")
                        .HasForeignKey("Ahlatci.Shop.Domain.Entites.Account", "CustomerId")
