        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CITY_ID = table.Column<int>(type: "int", nullable: false),
                    IDENDITY_NUMBER = table.Column<string>(type: "nchar(11)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IS_THUMBAIL = table.Column<bool>(type: "bit", nullable: false),
                    CREATE_DATE = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CREATE_BY = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MODIFIED_DATE = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MODIFIED_BY = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IS_APPROVED = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "0"),
                    CREATE_DATE = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CREATE_BY = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MODIFIED_DATE = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MODIFIED_BY = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PRODUCT_ID = table.Column<int>(type: "int", nullable: false),
                    QUANTİTY = table.Column<int>(type: "int", nullable: false),
